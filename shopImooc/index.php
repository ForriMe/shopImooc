...
<div class="shopList comWidth clearfix">
	...
	<div class="rightArea">
		...
		?>
			<div class="shop_item">
				<div class="shop_img">
					<a href="proDetail.php?id=<?php   echo $pro['id'] ?>" target="_blank"><img  height="200"width="187" src="image_220/<?php  echo $proImg['albumPath']; ?>" alt=""></a>
				</div>
		...
		<?php  
			$prosSmall = getProByCid($cate['id']);
			if($prosSmall && is_array($prosSmall)):
			foreach($prosSmall as $proSmall):
			$prosSmallImg = getProImgById($proSmall['id']);
		  ?>
			<div class="shopItem_sm">
				<div class="shopItem_smImg">
					<a href="proDetail.php?id=<?php  echo $proSmall['id'] ?>" target="_blank"><img  height="95"width="95"  src="image_50/<?php  
					echo $prosSmallImg['albumPath']; ?>" alt=""></a>
				</div>
